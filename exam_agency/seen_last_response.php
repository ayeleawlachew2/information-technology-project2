...
<?php
$query = mysqli_query($con, "select * from notification where committee_status='read'  and user_status='read' and pay_fee='Yes' and check_status='No' ORDER BY dates DESC")
or die(mysqli_error());
...
<div class="links-container">
    ...
    <span>Unseen Pay  Fee Request <span class="count-container">&nbsp;<?php echo $coun?>&nbsp;</span></span>
  </a>				
...
$count_item=mysqli_query($con, "select * from notification where committee_status='read'  and user_status='read' and pay_fee='Yes' and check_status='Yes'" ) or die(mysqli_error());
$count=mysqli_num_rows($count_item);	
echo"<font color='red'>".($count)."</font>"; ?></p>							
									<?php
$query1 = mysqli_query($con, "select * from notification where committee_status='read'  and user_status='read' and pay_fee='Yes' and check_status='Yes' ORDER BY dates DESC")
or die(mysqli_error());
?>

<?php
$sql = "select * from notification where committee_status='read'  and user_status='read' and pay_fee='Yes' and check_status='Yes' ORDER BY dates DESC";
