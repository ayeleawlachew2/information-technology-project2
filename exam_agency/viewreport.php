...
<div id="content">
<div class="content_item" style="margin-top: -900px; margin-left:50%;">
<div class="style1" id=textinput>
 <div style="height:600px;width: 750px;margin-top: 20px;
border:solid 4px #dldbeg;
overflow-y:scroll;
overflow-x:scroll;">
<?php
$totlarecordexist=mysqli_query($con, "select*from candidate where year='$year' and unversity='$university' ");
...
"</td> <td>".$rw1["ulname"]."</td> <td>".$rw1["sex"]."</td>  <td>".$row2["dept"]."</td> <td>".$row2["unversity"]."</td> <td>".$status."</td>
