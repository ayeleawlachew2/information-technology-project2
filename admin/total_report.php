...
$logout_time="empty";
$totlarecordexist=mysqli_query("select*from candidate where year='$year'");
...
$logsql=mysqli_query("insert into logtable values(' ','$uid','$username','$role','$login_time','$logout_time','$start_time','$activity_type','$activity','$ipaddress','$work_date')");
	//.....end log file record
