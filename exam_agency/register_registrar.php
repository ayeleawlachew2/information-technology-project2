...
<html>
<head>
  <title>Register Registrar page</title>
...
?>
 ...
 <fieldset id="fieldset">
  <legend style="font-weight: bold; font-size: 1.2em; color: #801137; border-bottom: 2px solid #801137; padding-bottom: 5px;">Register Registrar</legend>
...
<table class="form-table">
  <form action="" method="post" enctype="multipart/form-data" name="myForm" onsubmit="return validateForm()">
    <tr>
      <td>Registrar_ID:</td>
      <td><input type="text" name="rid" pattern="[a-zA-Z0-9/_.\-+]+" required /></td>
      <td>Mobile Phone:</td>
...
{
$sqa=mysqli_query($con, "select*from registrar where uid='$univer'");
...
$sq="insert into user values('$id','$fname','$mname','$lname','$sex','$mobile','$email','$photopath','$role')";
	...
	if($insert1)
	{
	$sql="insert into registrar values('$id','$univer','$committee_id')";	
