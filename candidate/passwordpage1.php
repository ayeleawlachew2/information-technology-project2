 ...
 $year=$row["year"];
  ...
  <form action="" method="post">
    ...
    <tr>
      ...
      <td style="padding: 10px;"><input type="submit" name="exampw" value="Go To Exam Page" style="width: 100%; padding: 10px; background-color: rgb(100, 185, 173); color: #fff; border: none; border-radius: 4px; cursor: pointer; transition: background-color 0.3s;">
</td>
    </tr>
  </form>
</table>
                    ...
                    if(isset($_POST["exampw"])) {
                      ...
                      // $dept = "Computer Science"; // Set the desired department
