...
?>		
  ...
  <a href="unreadd.php">
    ...
    <span>Unseen Request <span class="count-container"> </span></span>
  </a>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
$count_item=mysqli_query($con, "select * from notification where committee_status='read'" ) or die(mysql_error());
$count=mysqli_num_rows($count_item);	
echo"<font color='red'>".($count)."</font>"; ?></p>							
									<?php
$query1 = mysqli_query($con, "select * from notification where committee_status='read' ORDER BY dates DESC")
or die(mysqli_error());
?>

<?php
$sql = "select * from notification where committee_status='read' ORDER BY dates DESC";
