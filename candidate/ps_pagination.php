...
class PS_Pagination {
	 ...
	 * @return string
	 */
	function renderNext($tag = '<input type=button value=next></button>') {
		if ($this->total_rows == 0)
			return FALSE;
	 ...
	 * @return string
	 */
	function renderPrev($tag = '<input type=button value=prev></button>') {
		if ($this->total_rows == 0)
			return FALSE;
	 ...
	 * @return string
	 */
	function renderFullNavnext() {
		return   $this->renderNext();
	}
	function renderFullNavprev() {
